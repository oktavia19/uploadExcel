    ...
    <div class="panel panel-headline">
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form action="<?= url('hibahbansos/update') ?>" method='POST'>
                            ...
                            <div role="tabpanel" class="tab-pane active" id="home">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form-control" id="penerima" name="penerima" value="<?php echo $penerima;?>" required />
                                    </div>


                                <div class="form-group col-md-6">
                                    <label>Pemimpin (Kelompok / Organisasi)</label>
                                    <input type="text" class="form-control" name="pimpinan" id="pimpinan" value="<?php echo $pimpinan;?>" required />
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="bhi" id="bhi" value="<?php echo $bhi;?>" required />
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Nominal Pengajuan</label>
                                    <input type="number" class="form-control" name="nominal" value="<?php echo $nominal;?>"required />
                                </div>

                                <div class="col-md-6 col-xs-10">
                                    <label>Rencana Penggunaan disertai Satuan</label>
                                    <textarea class="form-control" name="uraian_keg_satuan"><?php echo $uraian_keg_satuan; ?></textarea>
                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane" id="kelengkapan2">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control datepicker" name="tanggal_permohonan" id="tanggal_permohonan" value="<?php echo $tanggal_permohonan;?>"/>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Nomor Surat Permohonan</label>
                                    <input type="text" class="form-control" name="nomor_permohonan" id="nomor_permohonan" value="<?php echo $nomor_permohonan;?>"  />
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Nomor Penerbitan Rekomendasi</label>
                                    <input type="text" class="form-control" name="nomor_penerbitan_rekomendasi" id="nomor_penerbitan_rekomendasi" value="<?php echo $nomor_penerbitan_rekomendasi;?>"/>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Tanggal Penerbitan Rekomendasi</label>
                                    <input type="text" class="form-control datepicker" name="tanggal_penerbitan_rekomendasi" id="tanggal_penerbitan_rekomendasi" value="<?php echo $tanggal_penerbitan_rekomendasi;?>"/>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Pejabat Penerbitan Rekomendasi</label>
                                    <input type="text" class="form-control" name="pejabat_penerbitan_rekomendasi" id="pejabat_penerbitan_rekomendasi" value="<?php echo $pejabat_penerbitan_rekomendasi;?>" />
                                </div>

                                <div class="col-md-6 col-xs-10">
                                    <label>Disposisi Ketua TAPD</label>
                                    <textarea class="form-control" name="isi_disposisi_ketua_tapd"><?php echo $isi_disposisi_ketua_tapd;?></textarea>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Tanggal Disposisi Bupati Tuban Pengajuan Proposal</label>
                                    <input type="text" class="form-control datepicker" name="tanggal_disposisi_bupati" id="tanggal_disposisi_bupati" value="<?php echo $tanggal_disposisi_bupati;?>" />
                                </div>

                                <div class="form-group col-md-6">
                                    <label>Tanggal Pertimbangan Ketua TAPD</label>
                                    <input type="text" class="form-control datepicker" name="tanggal_pertimbangan_ketua_tapd" id="tanggal_pertimbangan_ketua_tapd" value="<?php echo $tanggal_pertimbangan_ketua_tapd;?>" />
                                </div>
